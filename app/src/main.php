    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-xl-10">
                <div class="text-white font-raleway fw-700 h4">See How Our Services Work</div>
                ...
                $services = [
                    "service-flood-restoration" => [
                        1 => [
                            "question" => "What are Grout Lines?",
                            "answer" => "<p>A whitish residue on grout is typically caused by efflorescence. Efflorescence is the result of soluble salts or minerals that dissolve in water and come to the surface during evaporation. Efflorescence can come from moisture coming up through the cement slab or from the mortar itself.</p><div>Efflorescence can also occur when the water used to mix grout has a high mineral content.</div>",
                        ],
                        2 => [
                            "question" => "Why does my Grout have a whitish haze-like residue on it that can’t get off?",
                            "answer" => "If the shower is leaking and causing damage then yes, it is preferable to stop using the shower. However, in most cases it is usually quite a gradual leak so therefore the difference will be minimal between the time we quote to the time the work is completed so it is certainly not a necessity, especially if you only have the use of one shower. Once the shower has been re-grouted it will be 24 hours before it can be reused."
                        ]
                    ],
                                ...
                                <div class="accordion-head">
                                    <div class="main-question">
                                        <div class="row no-gutters">
                                            <div class="col-auto text-primary pr-2 pr-md-4"><?= $questionNumber ?></div>
                    ...
                    <div class="accordion-card">
                        ...
                        <div class="accordion-body" style="display: block;">
                            <div class="row no-gutters">
                                <div class="col-auto text-primary pr-2 pr-md-4 h14">A:</div>
                                <div class="col">
                                    <p>A whitish residue on grout is typically caused by efflorescence. Efflorescence is the result of soluble salts or minerals that dissolve in water and come to the surface during evaporation. Efflorescence can come from moisture coming up through the cement slab or from the mortar itself.</p>
